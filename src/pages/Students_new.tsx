        ...
        <Group>
          ...
          <Button 
            ...
            onClick={() => {
              ...
              console.log('localStorage data:', studentStorage.getStudents())
              notifications.show({
                title: 'Debug info',
                message: `${students.length} elever i state, ${filteredStudents.length} filtrerede, tjek konsol for detaljer`,
                color: 'blue'
              })
            }}
          >
                ...
                <Table.Tr key={student.id}>
                  ...
                  <Table.Td>
                    <Stack gap="xs">
                      ...
                      <Text size="xs" c="dimmed">{student.spor}</Text>
                    </Stack>
                  </Table.Td>
                  <Table.Td>
                    <Badge 
