...
export const studentSchema = z.object({
  ...
  kontaktperson1Rolle: z.string().optional().or(z.literal('')),
  kontaktperson1Navn: z.string().optional().or(z.literal('')),
  kontaktperson1Telefon: phoneSchema.optional(),
  kontaktperson1Email: emailSchema.optional(),
  kontaktperson2Rolle: z.string().optional().or(z.literal('')),
  kontaktperson2Navn: z.string().optional().or(z.literal('')),
  kontaktperson2Telefon: phoneSchema.optional(),
  kontaktperson2Email: emailSchema.optional(),
